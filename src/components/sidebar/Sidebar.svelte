...
<div
  class="bg-slate-800 p-2 w-48 h-full border-r border-r-slate-700 flex-col justify-between flex"
>
  <div role="tree">
  ...
  <div>
    <SidebarItem on:command={() => settingsOpen.set(true)}>Settings</SidebarItem
    >
  </div>
</div>
